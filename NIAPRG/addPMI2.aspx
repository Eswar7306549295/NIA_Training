<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addPMI2.aspx.cs" Inherits="PMI.addPMI2" %>
	...
	<div class="tab-content" id="totalCont">
	  ...
	  <span style="color:red;" id="errorMsg" ng-bind="errMsg" class="ng-binding"></span>
		<table style="width:100%;" border="1">
            <tr><td style="width:40%;"><label>Visitor Number <font>*</font></label>                     
                ...
                <td  style="width:60%;">
                   ...
                   <div class="bottom-video" style="float:right; " >
    <video id="video" autoplay="autoplay" height="140" width="180" onclick="takePhoto();" ></video>
    <canvas id="canvas" width='100' height='130' style=" visibility:hidden; position:absolute; left:0px;" ></canvas>
 </div>     <img width="150px" id="imgPhoto" height="130" style="float: left; padding-left:10px;"  /> 
             <asp:Image ID="imgprt" runat="server" Visible="false" Width="150" Height="130" style="float: left; padding-left:10px;"/>
                </td>
                </tr>
          
             <tr><td> <label>From/Organization <font>*</font></label>                   
                ...
                <td><label>whom to meet <font>*</font></label>
             ...
             <tr><td><label>Address <font>*</font></label>
                ...
                <td><label>Mobile <font>*</font></label>
             ...
             <tr><td> <label>Email ID <font>*</font></label>
                ...
                <td><label>Type of List </label>
                                   <asp:DropDownList ID="ddlTypeList" runat="server"  class="selectpicker form-control ng-pristine ng-untouched ng-valid" ng-init="nia.salutation = &#39;Mr.&#39;" >
                          <asp:ListItem Value="Office">Official</asp:ListItem>
                   <asp:ListItem Value="Personal">Personal</asp:ListItem>
                      </asp:DropDownList> </td></tr>
             <tr><td> <label>In Time. </label>
             ...
             <tr><td></td>
                <td></td></tr>
             <tr><td></td>
                <td><asp:Label ID="lbsingn" runat="server" Visible="false" Text="Signature"></asp:Label><br /></td></tr>
		</table>
        ...
        <div class="row">
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                   ...
                   <asp:Button ID="Button1" runat="server" Text="print" OnClick="Button1_Click"  CssClass="form-control btn btn-success .btn-next"  Width="30%" Height="100%"/>
