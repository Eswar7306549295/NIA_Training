<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="certificate.aspx.cs" Inherits="NIAPRG.lib.certificate" %>
...
<body>
    <form id="form1" runat="server">
        <br />
                ...
                <asp:label runat="server" ID="lblcourseid" Visible="false" ></asp:label>
...
<%--        <div class="row text-right">
        ...
        <div id="divnotgen" runat="server"  visible="false">
          ...
          <h3 style=' text-align: left; color: #3f6cb1; font-weight:bold;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Course training is mapped to 5 days training to issue completion certificate ,<br /> You can Download course completion certificate after 5 days of registration.</h3>
        </div>
