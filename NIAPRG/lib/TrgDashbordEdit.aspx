<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrgDashbordEdit.aspx.cs" Inherits="NIAPRGExams.exam.TrgDashbordEdit" %>
		...
		<!--Step 1: Identify Yourself-->
           ...
           <div class="row">
            ...
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                       <label>Gender<font>*</font></label>
                      <asp:DropDownList ID="ddlgender" runat="server" style="width:23%;float:left; font-weight:bold;" class="selectpicker form-control ng-pristine ng-untouched ng-valid">
                         <%--  <asp:ListItem Value="Select">Select</asp:ListItem>--%>
                          <asp:ListItem Value="M" Text="Male"></asp:ListItem>                        
                          <asp:ListItem Value="F" Text="Female"></asp:ListItem> 
                      </asp:DropDownList>
                      <label style="margin-top:-25px;margin-left:80px">Date of Birth <font>*</font></label>
                        <asp:TextBox ID="txtDob" runat="server"  class="form-control ng-pristine ng-untouched ng-valid ng-valid-maxlength" 
                            placeholder="DD/MM/YYYY" value="" data-mandatory="1"  ng-model="nia.txtDob"  data-validatefor="date" style="float:right;width:76%;"
         ...
         ServiceMethod="GetState" >
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                     <label>PIN Code <font>*</font></label>
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtAdhar" runat="server" class="form-control ng-pristine ng-untouched ng-valid ng-valid-maxlength" type="text" 
                        placeholder="" ng-model="nia.txtAdhar" data-mandatory="1" data-validatefor="number" data-errtext="Invalid Aadhaar number" 
                      ...
                      <asp:DropDownList  ID="ddlcompanylist" runat="server" class="form-control">
                        <%-- <asp:ListItem  Value="0">Choose any one </asp:ListItem>--%>
                         <%--  <asp:ListItem  Value="1">Bajaj Capital Insurance Broking Limited</asp:ListItem>
                           ...
                           <asp:ListItem Value="19">Landmark Insurance Brokers Pvt. Ltd</asp:ListItem>                          
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<asp:DropDownList ID="ddlEarlierExam" runat="server" 
                                        class="selectpicker form-control ng-pristine ng-untouched ng-valid"  AutoPostBack="true" ng-model="nia.ddlpositionOfManager" 
                                        data-validatefor="alfanumeric" OnSelectedIndexChanged="ddlEarlierExam_SelectedIndexChanged">   <%-- OnSelectedIndexChanged="ddlEarlierExam_SelectedIndexChanged" --%>
                         <asp:ListItem Value="1">No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
                      </asp:DropDownList>
          ...
          <div class="row">	
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlExamCentre" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid ng-pri" 
...
<%--<div class="row">
			...
			<div class="please-none-dec">
                ...
                <asp:FileUpload ID="FlPhoto" runat="server"  Width="100%" Height="100%" /></div>
                       <div class="col-md-6 col-sm-12 col-xs-12 text-left">
                            <asp:Button ID="btnimage" runat="server" Text="Upload" Width="30%" Height="100%" OnClick="btnimage_Click" OnClientClick="return ValidateForm();"  /> 
	...
	<div class="col-md-12 col-sm-12 col-xs-12"">
		<div style="padding:1% 0%; margin-left:auto; margin-right:auto;">
			<h5 class="title-pn">Please Upload Photo <font>*</font></h5>	
			<div class="please-none-dec">
				<p>Your photograph in jpg format, file size below 30 kb. File name should be given as your PAN Number_Name (e.g. AJCPK1122R_PriyankaDeshmukh.jpg)</p>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 text-middle">
             <asp:HyperLink ID="hplimage" runat="server" Target="_blank">
              
               <%--  <asp:Image ID="Image1" runat="server" ImageUrl='~/ImageFiles/<%# Eval("Photo")%>' />--%>
               
                               </asp:HyperLink><br />
                <asp:HyperLink ID="hplctf" runat="server" Target="_blank"></asp:HyperLink>
              </div>
...
<%--							<asp:Button ID="btnsubmit"  CssClass="form-control btn btn-success .btn-next" runat="server" OnClientClick="return ValidateForm();" BackColor="#009688"   ForeColor="#ffffff"
    Font-Bold="true" ValidationGroup="vg" CausesValidation="true"  Text="PROCEED TO PAY"  width="30%" Height="100%" />--%>
<asp:button id="btnupdate" cssclass="form-control btn btn-success .btn-next" runat="server" onclientclick="return validateform();" backcolor="#009688"   forecolor="#ffffff"
    font-bold="true" validationgroup="vg" causesvalidation="true"  text="update"  onclick="btnupdate_click"  width="30%" height="100%" />  <%--onclick="btnupdate_click" --%>
					</div>
    ...
    <script type="text/javascript">
        ...
        function ValidateForm() {
            ...
            if (!$("#totalCont").validateForm({ validate: "execute", error_align: "bottom" })) {
                ...
                var TDetailsTrInstitute = document.getElementById('TxtDetailsTrInstitute').value;
                if (TDetailsTrInstitute == "") {
                    alert("Please Enter Training Institute Name");
                    document.getElementById('<%=TxtDetailsTrInstitute.ClientID %>').focus();
                    return false;
                }
                    ...
                    if (gender == "0") {
                        ...
                        if (state == "0") {
                            ...
                            if (company == "0") {
                                ...
                                var SponsorState = document.getElementById('ddlSponsorState').value;
                                if (SponsorState == "0") {
                                    alert("Please Select Sponsor State");
                                    document.getElementById('<%=ddlSponsorState.ClientID %>').focus();
                                    return false;
                                }
