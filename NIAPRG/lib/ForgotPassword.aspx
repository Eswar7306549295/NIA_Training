<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="NIAPRG.lib.ForgotPassword" %>
                    ...
                    <div class="graphs">
                        <div class="sign-in-form">
                            <div class="sign-in-form-top">
                                <p style="margin-top: 40px;"><span>Forgot Password</span> </p>
                            </div>
                            <div class="signin">
                                ...
                                <div class="log-input">
                                    <div class="log-input-left">
                                       <%-- <label>UserName</label>--%>
                                        <asp:TextBox runat="server" ID="txtusername" placeholder="Enter Username / PANNo" autocomplete="off" onfocus="this.value = '';" required />
                                    </div>
                                ...
                                <div class="log-input">
                                    <div class="log-input-left">
                                        <%--<label>Email</label>--%>
                                        <asp:TextBox runat="server" ID="txtemail" placeholder="Enter Email" type="text" autocomplete="off"  onfocus="this.value = '';" required />
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <asp:Button runat="server" ID="btnsubmit" type="submit"  Text="Get Password" OnClick="btnsubmit_Click" />
                                <br />
                                <br />
