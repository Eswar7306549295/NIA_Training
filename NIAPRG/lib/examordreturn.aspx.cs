...
{
    public partial class examordreturn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          "  Congratulations! You have now successfully enrolled for the  Online Course for Brokers’ examination.  We heartily welcome you.<br />" +
           ...
           " You can download the Training Completion Certificate using following link. <br/> <a href=' https://e-learning.niapune.org.in '> https://e-learning.niapune.org.in</a> <br />" +
            "After completion of 50/25 hours training you will be able to get completion certificate on the NIA portal. Go to the My Learning -> View Courses -> Complted Tab then click on the 'Print Certificate'." +
     ...
     "  we have sent the confirmation with Access details to your mail id</h3><h3 style=' text-align: left; color: #3f6cb1; font-weight:bold;'>Please <a href='http://e-learning.niapune.org.in'> Click Here</a> to login your account </h3>";
        ...
        private void UpdateNIA(int STATUS, string _customerId, string ErrorStatus, string txnReferenceNo, string RealCid)
        {
            ...
            cmd.Parameters.Add("@ExamTranStatus", ErrorStatus);
            cmd.Parameters.Add("@ExamTransRefNo", txnReferenceNo);
            cmd.Parameters.Add("@ExamcustomerId", RealCid);
            cmd.Parameters.Add("@id", _customerId);
            cmd.ExecuteNonQuery();
            cnn.Close();
        }
