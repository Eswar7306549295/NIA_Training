...
{
    public partial class TrgAdminReportNew : System.Web.UI.Page
    {
        ...
        private void BindData(string pageindex, string pagesize)
        {
           ...
           // string type = ddltype.SelectedValue.ToString();
            cnn.Open();
            SqlCommand cmd = new SqlCommand("sp_trgAdminReport", cnn);
            cmd.CommandType = CommandType.StoredProcedure;
             cmd.Parameters.AddWithValue("@fromdate", txtstart.Text);
