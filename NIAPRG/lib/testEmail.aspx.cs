...
namespace NIAPRG.lib
{
    public partial class testEmail : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            mailMessage.Body = "<html><body style='font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.42857143; color: #333;' >  Dear ( the learner’s name),<br /><br />" +
  "  Congratulations! You have now successfully enrolled for the  Online Course for Brokers’ examination.  We heartily welcome you.<br />" +
   " The fact thatthe classes are  brought to you by the National Insurance Academy, the premier institution for insurance education and the examination body for the brokers in India. We thank you for choosing our Course.<br />" +
    "The course is developed to equip the candidates to appear for the Insurance Brokers Examination as prescribed in the IRDAI Regulations.<br />" +
    "The advantage is that this course contains a number of lessons which you can learn at your own pace and convenience at any time of the day. You can also refresh your knowledge by revising those subjects you have already learnt by referring to the Table of Contents and clicking on the relevant topics. You need to complete a  minimum of 50 hours (25 hours for those who satisfy conditions prescribed by IRDAI) of this course to appear for the examination. The time you spent on the lessons will be tracked by the system on a cumulative basis.<br />" +
    "We hope you will have a pleasant learning experience and wish you all the best for your success in the examination.<br /> " +
   "<p style='text-align:right;'> <b> -Team NIA</b></p>" +
    "You can access the course through the following URL: <a href=' https://e-learning.niapune.org.in '> https://e-learning.niapune.org.in</a> <br />" +
    "<b>Your Login id </b> : <br />" +
    "<b> Your Password </b>: <br /><br />" +
   " Please mail to <a href='lms-support@niapune.org.in'>lms-support@niapune.org.in</a> if you face problem to access above" +
    ...
    "<b> Availability</b> :<br />" +
    "Please note that the training module will be available up to   i.e. for 60 days from the date of enrollment. Even if you have downloaded the certificate, training module will be available for 60 days" +
   ...
   " You can download the Training Completion Certificate using following link.<br />" +
    ...
    "<h3>Training Module Help</h3><b>TIME CALCULATION</b><br /><ul><li>The basis of completion of the training is number of hours spent by you "+
           ...
           " modules which are relevant to your syllabus. Other modules are optional which can be"+
            "accessed by you if you desire to have additional information."+
        "</li> <li> The Training module is slides having three characters (One learner and two faculty members). As soon as you begin the training module,"+
           " the system will start calculating the time. </li><li> The training module software will keep track of the hours of training. "+
         "The number of training hours completed will be displayed at the right lower corner of the screen."+
        "</li> <li> The following is the list of modules to be completed for the respective training program selected by you. </li>"+
...
"</body></html>";
 ...
 //           mailMessage.Body = "<html><body> Dear lakshmi," + Environment.NewLine + Environment.NewLine +
 //               "Your NIA Registration Process was Completed Successfully." + Environment.NewLine +
 //               "Please find your Login details: " + Environment.NewLine +
 //               "User Name : kvs" + Environment.NewLine +
 //               "Password : 123" + Environment.NewLine +
 //                  " URL : ur message : <a href=' https://e-learning.niapune.org.in '> https://e-learning.niapune.org.in</a>" + Environment.NewLine +
 //               "Thank You So Much for reposing the trust in us ." + Environment.NewLine +
 //"Yours" + Environment.NewLine +
 //"Team NIA </html></body>";
            //mailMessage.Body = "Dear lakshmi," + Environment.NewLine + Environment.NewLine + Environment.NewLine +
            //               "Your NIA Registration Process was not Completed ." + Environment.NewLine + Environment.NewLine +
            //               "Please try again : " + Environment.NewLine +

            //               " URL : http://e-learning.niapune.org.in" + Environment.NewLine +
            //               "Thank You So Much for reposing the trust in us ." + Environment.NewLine + Environment.NewLine +
            //"Yours" + Environment.NewLine + Environment.NewLine +
            //"Team NIA </div>";
