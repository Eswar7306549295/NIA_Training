<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrgDashbord.aspx.cs" Inherits="NIAPRG.lib.TrgDashbord" %>
                                            ...
                                            <table style="width: 90%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left; padding-left: 5px">
                                                        <div class="form-inline">
                                                            <div class="form-group">
                                                                <label for="email" id="lblSearch" runat="server">Search(Name,PAN,Mobile,EmailID):</label>
