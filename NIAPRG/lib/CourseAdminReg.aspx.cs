...
namespace NIAPRG
{
    public partial class CourseAdminReg : System.Web.UI.Page
    {
        public string Eq1 = "", Eq2 = "", Eq3 = "", Eq4 = "", Eq5 = "", Eq6 = "", Eq7 = "", Eq8 = "", Eq9 = "", Eq10 = "", Eq11 = "", Eq12 = "", Eq13 = "", Eq14 = "", Eq15 = "";

        protected void Button2_Click(object sender, EventArgs e)
        {
            Server.Transfer("CourseAdminUsersList.aspx");
        }
        ...
        protected void callbilldesk_Click(object sender, EventArgs e)
        {
            string id = "";
            string PaymentAmount = "", email = "", mobile = "", Name = "", PANno = "";
            SqlConnection cnn = new SqlConnection(ConfigurationManager.AppSettings["DSN"]);
            cnn.Open();
            string query2 = "SELECT  [Id] ,[Name] ,[Mobile] ,[PANNo] ,status ,PaymentAmount ,[TransRefNo] ,[TranStatus] FROM [LearningServer].[dbo].[NiaApplicants] where TransRefNo is null and AdminID='" + value + "'";
                ...
                if (str.Length > 0)
                {
                    if (CHKagree.Checked)
                    {
                        ...
                        else
                        {
                            ...
                            command.Parameters.Add("@Name", txtnameOfCandidate.Text.ToUpper().Trim());
                            ...
                            command.Parameters.Add("@IIImumbai", ddlIIImumbai.SelectedItem.Text);
                            command.Parameters.Add("@IRMmumbai", ddlIRMmumbai.SelectedItem.Text);
                            command.Parameters.Add("@IAI", ddlIAI.SelectedItem.Text);
                            command.Parameters.Add("@IIRMhyd", ddlIIRMhyd.SelectedItem.Text);
                            command.Parameters.Add("@CIIlondon", ddlCIIlondon.SelectedItem.Text);
                            command.Parameters.Add("@ICAI", ddlICAI.SelectedItem.Text);
                            command.Parameters.Add("@ICFAI", ddlICFAI.SelectedItem.Text);
        ...
        {
            if ((ddlIIImumbai.SelectedItem.Text == "Yes") || (ddlIRMmumbai.SelectedItem.Text == "Yes") || (ddlIAI.SelectedItem.Text == "Yes") || (ddlIIRMhyd.SelectedItem.Text == "Yes") || (ddlCIIlondon.SelectedItem.Text == "Yes") || (ddlICAI.SelectedItem.Text == "Yes") || (ddlICFAI.SelectedItem.Text == "Yes"))
            {
                ...
                if (str.Length > 0)
                {
                    if (CHKagree.Checked)
                    {
                        ...
                        else
                        {
                            ...
                            command.Parameters.Add("@Action", "insert");
                            command.Parameters.Add("@salutation", ddlsalutation.SelectedItem.Text);
                            command.Parameters.Add("@Name", txtnameOfCandidate.Text.ToUpper());
                            command.Parameters.Add("@DateofBirth", txtDob.Text);
                            command.Parameters.Add("@Address", txtAddress.Text);
                            command.Parameters.Add("@Pin", txtpin.Text);
