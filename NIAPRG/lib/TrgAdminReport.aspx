<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrgAdminReport.aspx.cs" Inherits="NIAPRG.lib.TrgAdminReport" %>
                            ...
                            <div>
                                ...
                                <div class="bs-example4" data-example-id="simple-responsive-table">
                                    ...
                                    <div class="Table-Row" id="spnsrRpt" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                 ...
                                                 <div class="col-md-2">
                                                    ...
                                                    <asp:Button runat="server" ID="btnExport" Text="Export Excel" CssClass="btn-primary btnexcel"  OnClick="btnExport_Click" />
                                        ...
                                        <div class="col-md-4"><asp:Label ID="lblphotos" runat="server" style="padding-left:30px" ForeColor="#CC0000"></asp:Label></div>--%>
                                            </div>
