<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseAdminReg.aspx.cs" Inherits="NIAPRG.CourseAdminReg" %>
...
<body style=" background-image: url(./nia_files/vgradppFresh.gif);">
...
<!--Header-->
 ...
 Visible="false"></asp:Label>         
            ...
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                     <label>Tele Phone <font>*</font></label>
          ...
          <div class="col-md-12 border_sp"></div>
           ...
           <div class="bd-eqd-title">
                     <p>
                     <font style="color:blue"> Please select Qualification for eligibility of 25 hours training  <font style="color:red">*</font></font>
                     </p>
                  </div>
                   <div class="col-md-12 border_sp">
 						<%--<div class="row">					
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Are you carrying any Reinsurance related activity ?   </label>
                      <asp:DropDownList ID="ddlreinsuranceReActi" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" AutoPostBack="true" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Are you a principal underwriter for last 7 years ?   </label>
                                     <asp:DropDownList ID="ddlprincipleUnderwriter" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                         <asp:ListItem Value="1">No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
						...
						<div class="row">					
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<asp:DropDownList ID="ddlinsuranceConsultant" runat="server"  OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged"
                           ...
                           <asp:ListItem Value="2">Yes</asp:ListItem>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<asp:DropDownList ID="ddlpositionOfManager" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged"
          ...
          <div class="row">					
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Associate/ Fellow of the Insurance Institute of India, Mumbai   </label>
                      <asp:DropDownList ID="ddlIIImumbai" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" AutoPostBack="true" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                          <asp:ListItem Value="1" >No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label> Associate/ Fellow of the Institute of Risk Management, Mumbai   </label>
                                     <asp:DropDownList ID="ddlIRMmumbai" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                         <asp:ListItem Value="1">No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
           ...
           <div class="row">	
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Associate/ Fellow of the Institute of Actuaries of India   </label>
                      <asp:DropDownList ID="ddlIAI" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" AutoPostBack="true" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                          <asp:ListItem Value="1" >No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>  Chartered Financial Analyst of ICFAI.  </label>
                      <asp:DropDownList ID="ddlICFAI" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" AutoPostBack="true" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                          <asp:ListItem Value="1" >No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
           ...
           <div class="row">					
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Associate/ Fellow of Chartered Insurance Institute, London   </label>
                      <asp:DropDownList ID="ddlCIIlondon" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" AutoPostBack="true" runat="server" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                          <asp:ListItem Value="1" >No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>  Post graduate qualification of the Institute of Insurance and Risk Management, Hyderabad   </label>
                                     <asp:DropDownList ID="ddlIIRMhyd" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                         <asp:ListItem Value="1">No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
          ...
          <div class="row">					
								<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label>Associate/ Fellow of – Institute of Chartered Accountants of India, Institute of Cost Accounts and Works of India, Institute of Company Secretaries of India    </label>
                                     <asp:DropDownList ID="ddlICAI" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlreinsuranceReActi_SelectedIndexChanged" class="selectpicker form-control ng-pristine ng-untouched ng-valid" >
                         <asp:ListItem Value="1">No</asp:ListItem>
                           <asp:ListItem Value="2">Yes</asp:ListItem>
          ...
          <div class="row">					
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
                                   ...
                                   <asp:TextBox ID="LbEligibleHours" ReadOnly="true" class="form-control ng-pristine ng-untouched ng-valid ng-valid-maxlength"  runat="server" Text="50 Hours" ></asp:TextBox>
								</div>
							</div>						
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<asp:DropDownList ID="DdlReqHours" runat="server" 
                                        class="selectpicker form-control ng-pristine ng-untouched ng-valid" ng-model="nia.ddlpositionOfManager" 
                                        data-validatefor="alfanumeric" Enabled="false" style="height:40px;" >
                         <asp:ListItem Value="50" Selected="True">50 Hours</asp:ListItem>
                           <asp:ListItem Value="25">25 Hours</asp:ListItem>
                      </asp:DropDownList>
                                   
                                    <br />
&nbsp;<span style="color: rgb(255, 0, 0); font-family: Calibri, sans-serif; font-size: 14.6667px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Note :&nbsp; Certificate will be generated based on Required Hours.</span></div>
							</div>
						</div>
						<div class="col-md-12 border_sp"></div>
						...
						<div class="form-group">
                          ...
                          <asp:ListItem Value="0">Select</asp:ListItem>
                           <asp:ListItem Value="2021_NIA01">Direct Life Insurance</asp:ListItem>
                           <asp:ListItem Value="2021_NIA02">Direct General Insurance</asp:ListItem>
                                 <asp:ListItem Value="2021_NIA03">Direct Life and General Insurance</asp:ListItem>
                                  <asp:ListItem Value="2021_NIA04">Reinsurance</asp:ListItem>
                                  <asp:ListItem Value="2021_NIA05">Composite</asp:ListItem>
                      </asp:DropDownList>
                            						</div>
					</div>
						</div>
		...
		<!--Step 3: Disclaimer-->
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="bd-m-p">
                        <asp:Label ID="LBAMT" runat="server" Text="2360.00" Visible="false"></asp:Label>
							<input type="hidden" id="AMT1" runat="server" ng-model="nia.txnAmt" value="2360.00"  class="ng-pristine ng-untouched ng-valid" /> Payment Amount : Rs.2360.00/-  ( Fresh Course Registration : Rs. 2000/- + 18% GST)
						</div>
					</div>
				</div>
			</div>
	...
	<div class="col-md-12 col-sm-12 col-xs-12"">
		<div style="padding:1% 0%; margin-left:auto; margin-right:auto;">
			...
			<div class="please-none-dec">
                ...
                <asp:FileUpload ID="FlPhoto" runat="server"  Width="3100%" Height="100%" /></div>
...
For Any support, have a look at Contact US page
    ...
    Font-Bold="true" ValidationGroup="vg" CausesValidation="true"  Text="Submit"   width="30%" Height="100%" OnClick="btnregister_Click" />		
                <asp:Button ID="Button2"  CssClass="form-control btn btn-success .btn-next" runat="server"  BackColor="#009688"   ForeColor="#ffffff"
    Font-Bold="true" ValidationGroup="vg" CausesValidation="true"  Text="PROCEED TO PAY"  width="30%" Height="100%" OnClick="Button2_Click" />
					</div>
                        ...
                        if (result2 == "0") {
                            ...
                            if (result2 == "") {
                                ...
                                if (company == "0") {
                                    ...
                                    var r = confirm(" Are you sure you want to pay for BROKERS’  FRESH  ONLINE TRAINING ?  Payment once made will not be refunded ");
                                    if (r == true) {
